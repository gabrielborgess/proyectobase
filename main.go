...
func main() { // Esta muy feo, apenas aprenda a iterar listas aqui lo arreglo
	...
	execdb("CREATE TABLE clientes ( id integer, data varchar(250) )")
	...
	execdb("CREATE TABLE pedidos( id integer, data varchar(255) )")
	execdb("DROP TABLE IF EXISTS `detalle_pedidos`")
	execdb("CREATE TABLE detalle_pedidos ( id integer, data varchar(255) )")
	execdb("DROP TABLE IF EXISTS `productos`")
	execdb("CREATE TABLE productos ( id integer, data varchar(255) )")
	execdb("DROP TABLE IF EXISTS `proveedores`")
	execdb("CREATE TABLE proveedores( id integer, data varchar(255) )")
	execdb("DROP TABLE IF EXISTS `empleados`")
	execdb("CREATE TABLE empleados ( id integer, data varchar(255) )")
	execdb("DROP TABLE IF EXISTS `genero`")
	execdb("CREATE TABLE genero ( id integer, data varchar(255) )")
	execdb("DROP TABLE IF EXISTS `metodo_pago`")
	execdb("CREATE TABLE metodo_pago ( id integer, data varchar(255) )")
